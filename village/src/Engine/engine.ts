...
export class Engine {
    ...
    private createScene(): BABYLON.Scene {
        ...
        new Village(scene, this.shadowGenerator);
        new World(scene);
        // new Skybox(scene);
        new Tree(scene);
        new Car(scene, this.shadowGenerator);
        new Fountain(scene, this.shadowGenerator);
        new Light(scene, this.shadowGenerator);
        new People(scene, this.shadowGenerator);
